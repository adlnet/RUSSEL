...
public class DetailScreen extends Screen {
	protected AlfrescoPacket record;
	protected AlfrescoPacket fullRecord = null;
	protected AlfrescoPacket ratings = null;
	protected AlfrescoPacket comments = null;
	...
	protected static StatusPacket adl3drPartialOp; 
	 ...
	 * @param r AlfrescoPacket information for the node
	 * @param isModal Boolean True if in full screen view, false if in modal view. 
	 */
...
//		PageAssembler.attachHandler("r-commentCount", Event.ONCLICK, Russel.nonFunctional);
	 ...
	 * @param ap AlfrescoPacket retrieved list of Alfresco comments
	 */
	 ...
	 * @param commentNode AlfrescoPacket packet for a particular comment
	 */
	 ...
	 * @param feedback Adl3DRPacket list of 3DR feedback records
	 */
	private void fillComments0(Adl3DRPacket feedback) {
		RootPanel.get("r-commentArea").clear();
		for (int x=0;x<feedback.getCommentCount();x++) 
			if (x<10) 
				fillComment0((Adl3DRPacket)feedback.getSearchRecords().get(x));
	 ...
	 * @param feedback Adl3DRPacket a particular 3DR feedback record
	 */
	 ...
	 * @param ap AlfrescoPacket information on the node
	 */
	 ...
	 * @param ap AlfrescoPacket general information on the node
	 * @param ratings AlfrescoPacket ratings on the node
	 * @param comments AlfrescoPacket comments on the node
	 */
